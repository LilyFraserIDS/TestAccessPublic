...
🛡️ Found a security issue in the [TestAccessPublic]([https://github.com/LilyFraserIDS/TestAccessPublic) project? Read on.
...
To report a vulnerability via email, send an email to TestAccessPublic@googlegroups.com - which is a private, maintainer-only group.
